...
export default function WhatsAppBar({ href }: Readonly<{ href: string }>) {
  ...
  return (
    <div className="pointer-events-none fixed bottom-0 left-1/2 flex w-full max-w-[520px] -translate-x-1/2 items-center gap-3 border-t border-[rgb(18_35_61/0.14)] bg-[rgb(248_247_243/0.94)] px-3.5 pt-2.5 pb-3.5 backdrop-blur-[8px] md:max-w-[760px] lg:max-w-[880px] lg:px-8 xl:max-w-none xl:px-14">
