export default function WaButton({
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener"
      className={`flex min-h-[50px] items-center justify-center gap-2.5 rounded-[5px] bg-wa select-none text-[15.5px] font-bold tracking-[-0.1px] text-white transition-[background-color,transform] duration-150 hover:bg-wa-dark focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-wa-dark active:scale-[0.985] lg:min-h-[56px] lg:text-[17.5px] xl:min-h-[60px] xl:text-[19px] ${className}`}
    >
      <svg
        aria-hidden
        viewBox="0 0 24 24"
        fill="currentColor"
        className="size-[20px] flex-none lg:size-[22px]"
      >
