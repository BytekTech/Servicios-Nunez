...
export default function HomeHero() {
  return (
    <section className="bleed relative flex flex-1 flex-col justify-center overflow-hidden">
      ...
      />
      <div className={`relative mx-auto w-full px-5 py-24 short-landscape:py-12 lg:px-8 xl:px-14 ${CONTENT_WIDTH}`}>
        <SectionLabel className="rise mb-3.5" accent="text-paper">
          ELECTRICIDAD · PLOMERÍA · GAS
        </SectionLabel>
        <h1 className="rise rise-2 text-[34px] leading-[1.06] font-extrabold tracking-[-0.8px] text-pretty text-paper md:text-[40px] lg:text-[44px] lg:leading-[1.04] lg:tracking-[-1.2px] xl:text-[54px] xl:tracking-[-1.6px] 2xl:text-[64px] 2xl:tracking-[-1.9px]">
        ...
        <p className="rise rise-3 mt-4 max-w-[65ch] text-[15.5px] leading-normal text-pretty text-mist md:text-[17px] lg:text-[19px] xl:text-[21px]">
